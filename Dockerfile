...
RUN mkdir -p /usr/src/telco_service
...
COPY src /usr/src/telco_service/
WORKDIR /usr/src/telco_service
...
RUN chmod +x /usr/src/telco_service/tasks.py \
    && chmod +x /usr/src/telco_service/entrypoint.sh
...
# ENTRYPOINT /usr/src/telco_service/entrypoint.sh
