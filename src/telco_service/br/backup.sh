...
#
# e.g.:
#  docker exec -it django4telco_service sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./telco_service/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING telco_service BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/telco_service/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
